...
const BottomPageScreen = () => {
    // <footer className= "min-h-screen bg-customGreenLight pt-10 pl-20  pb-10 pr-20 ">
    //   <div className="flex  "></div>
    return (
        <footer className="min-h-screen bg-white pt-10 pl-20  pb-10 pr-20 ">
            <div className=" ">
...
export default BottomPageScreen;
