...
const Logistics = () => {
  return (
    ...
    <h1 className="text-4xl font-bold text-customGreenLight mb-20">Request Logistics</h1>
    ...
    <div className="text-center justify-center space-y-10  ">
      <div>
      <div className="text-3xl font-bold text-customGreenLight  ">Schedule or </div>
      <div className="text-3xl font-bold text-customGreenLight ">Immediate Delivery</div>
      <div className="text-3xl font-bold text-customGreenLight ">Totally up to you </div>
      </div>
      

      <div className="flex items-center justify-center bg-customGreenLight h-16 w-48
      cursor-pointer  rounded-lg mt-4 m-14">
          <div className="text-xl  
          font-bold">Request a Delivery</div>
        </div>
     ...
     <div className="w-full max-w-4xl bg-customVeryLightGray  rounded-lg shadow-lg p-8   ">
        ...
        <div className="relative w-full max-w-xs">
            ...
            />
            <img src={input} alt="icon" className="absolute right-2 top-1/2 transform -translate-y-1/2 w-6 h-6" />
        </div>
        <div className="relative w-full max-w-xs">
            <div className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-customGreenDark w-3 h-3 rounded-full"></div>
            <input 
