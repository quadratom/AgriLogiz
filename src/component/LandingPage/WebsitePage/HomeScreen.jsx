        ...
        >
            <div className="flex  items-center justify-center ml-20 gap-10 ">
                <div className="text-start space-y-8">
                    ...
                    <div
                        className="group flex items-center justify-center bg-customGreenLight h-16 w-48
      hover:bg-customGreenMedium  cursor-pointer  rounded-lg mt-4 m-14"
                    >
                        <div className="text-2xl text-customGreenDark group-hover:text-customGreenLight font-bold">
                            Learn More
                        </div>
                    </div>
                </div>
